...
public class Tambahdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1 = (EditText) findViewById(R.id.etNomor);
        text2 = (EditText) findViewById(R.id.etNama);
        text3 = (EditText) findViewById(R.id.etHp);
        text4 = (EditText) findViewById(R.id.etJenis);
        text5 = (EditText) findViewById(R.id.etAlmt);
